...
const (
	...
	GreetingService_HelloClientStream_FullMethodName = "/hello.GreetingService/HelloClientStream"
	GreetingService_HelloBiStreams_FullMethodName    = "/hello.GreetingService/HelloBiStreams"
)
